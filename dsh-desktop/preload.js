...
function renderMenu() {
  ...
  menuEl.innerHTML = `
    <div class="dch-mh">
      <div class="dch-mh-title">Deepseek Harness EAC v2.0 <span style="font-weight:400;color:var(--dsw-alias-label-tertiary)">封装 v${esc(state.appVersion)}</span></div>
    ...
    <div class="dch-sep"></div>
    <button class="dch-item" data-act="about">关于 Deepseek Harness EAC v2.0</button>
...
function injectChrome() {
  ...
  bar.innerHTML = `
    <div class="dch-left">
      ...
      <span class="dch-title">Deepseek Harness EAC v2.0</span>
