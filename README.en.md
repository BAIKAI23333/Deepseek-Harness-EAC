...
| dsh-stt (provider: BAIKAI23333) | Offline local speech-to-text: sherpa-onnx SenseVoice fills the composer from microphone input with wake words and a "send" voice command (off by default, Windows only) |
